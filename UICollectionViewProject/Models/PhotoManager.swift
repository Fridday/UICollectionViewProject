...
class PhotoManager {
    ...
    static let albumName = "Wallpaper App"
    static let shared = PhotoManager()
    
    
    enum persmisionState {
        case authorized
        case denied
        case notDetermined
        case restricted
    ...
    func checkPermision() -> persmisionState {
    ...
    func requestAuthorizationHandler(status: PHAuthorizationStatus) {
        if PHPhotoLibrary.authorizationStatus() == PHAuthorizationStatus.authorized {
            ...
            // PopUpManager.onNoPhotoGalleryPermision(withViewController: self)
